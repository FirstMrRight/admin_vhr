...
/**
 * @author Liu-PC
 * @version : POIUtils, v 0.1 2020/8/20 20:10 Liu-PC Exp$
 */
public class POIUtils {
    ...
    public static ResponseEntity<byte[]> employee2Excel(List<Employee> list) {
        ...
        //设置公司信息
        docInfo.setCompany("www.aidaodaochengxugou.com");
        //4.获取文档摘要信息
        SummaryInformation sumInfo = workbook.getSummaryInformation();

        sumInfo.setTitle("员工信息表");
        sumInfo.setAuthor("爱叨叨的程序狗");
        sumInfo.setComments("本文档由爱叨叨的程序狗提供");
...
//        创建行和列
     ...
     * @return
     */
    public static List<Employee> excel2Employee(MultipartFile file, List<Nation> allNations, List<Politicsstatus> allPoliticsstatus, List<Department> allDepartments, List<Position> allPosition, List<JobLevel> alljobLevels) {
